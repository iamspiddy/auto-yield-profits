            ...
            <CardContent className="p-8">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground">
                  Your {formData.method} withdrawal request has been submitted for processing. You will receive a notification once it's completed.
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="p-4 border rounded-lg bg-muted/30">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-medium">{withdrawalMethod} Details</span>
                </div>
                {renderMethodFields()}
              </div>
